--[[
    ...
    simply display "Arkanoid" in large text, as well as a message to press
    Enter to begin.
]]
...
function StartState:render()
    ...
    love.graphics.printf("Arka Group 8 ", 0, VIRTUAL_HEIGHT / 3,
    ...
    love.graphics.printf('Press 1 for Sound Track 1', 0, 130,VIRTUAL_WIDTH, 'center')
    love.graphics.printf('Press 2 for Sound Track 2', 0, 150,VIRTUAL_WIDTH, 'center')
end