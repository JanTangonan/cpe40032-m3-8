--[[
    ...
    Group 8 Bs CpE 2 - 1
    and this is the screen cast of our arkanoid modification

    1st task is to create a power up class

    2nd is to make the paddle shrink and grow

    3rd is to make a locked brick that gets unlocked using a key power up 

    we also added some few features
...
function love.load()
    ...
    love.window.setTitle('Arkanoidy 8')
